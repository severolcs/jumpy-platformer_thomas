...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Bumper, function (sprite, otherSprite) {
    if (sprite.vy > 0 && !(sprite.isHittingTile(CollisionDirection.Bottom)) || sprite.y < otherSprite.top) {
        ...
        info.changeLifeBy(-1)
        sprite.say("Aii!", invincibilityPeriod)
...
function giveIntroduction () {
    ...
    game.setDialogCursor(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)
    showInstruction("Thomas Jumper - Let's Go!")
    showInstruction("seus burros let's go!")
...
function animateIdle () {
    ...
    mainIdleLeft.addAnimationFrame(img`
        ...
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 . . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 e f . 
        . 2 2 d 2 2 2 2 2 2 2 2 2 2 2 . 
        . f d d f d d 2 2 2 2 2 2 2 2 . 
        . f d d f d d d d f 2 2 2 2 2 . 
    ...
    mainIdleRight.addAnimationFrame(img`
        ...
        . 8 e e e e 8 e e e 8 e e e f . 
        . 8 8 e e d 8 d d d d d d d f . 
        . f d 8 8 8 8 d d d d f d d f . 
